...
@Component({
  selector: 'app-widgets-arrow',
  templateUrl: './widgets-arrow.component.html',
  styleUrls: ['./widgets-arrow.component.scss'],
  changeDetection: ChangeDetectionStrategy.Default
})
export class WidgetsArrowComponent implements OnInit, AfterContentInit {
